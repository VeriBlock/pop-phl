...
// placeh includes.
#include <..\src\script\placehconsensus.h>
...
int main()
{
    std::cout << "placehconsensus version: " << placehconsensus_version() << std::endl;
    ...
    auto op0Result = placehconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, placehconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
