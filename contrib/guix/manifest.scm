...
(define* (make-placeh-cross-toolchain target
                                  #:key
...
desirable for building Placeholders Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-placeh-cross-toolchain "i686-linux-gnu")
       (make-placeh-cross-toolchain "x86_64-linux-gnu")
       (make-placeh-cross-toolchain "aarch64-linux-gnu")
       (make-placeh-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-placeh-cross-toolchain "riscv64-linux-gnu"
