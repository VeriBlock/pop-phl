...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the placeh repository."
  exit 1
fi
...
# See https://github.com/placeh/placeh/issues/16064
...
echo 'When compiling placehd, run `./configure` in the following way:'
echo
