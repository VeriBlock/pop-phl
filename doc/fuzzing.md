Fuzz-testing Placeholders Core
==========================
...
```
git clone https://github.com/placeh-core/qa-assets
...
To build Placeholders Core using AFL instrumentation (this assumes that the
