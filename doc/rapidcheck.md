# RapidCheck property-based testing for Placeholders Core

## Concept

Property-based testing is experimentally being added to Placeholders Core with
...
If RapidCheck is installed, Placeholders Core will automatically run the
...
3. Configure Placeholders Core with RapidCheck.

    `cd` to the directory of your local placeh repository and run
...
4. Build Placeholders Core with RapidCheck.
    ...
    Making all in src
    [...]
    CXX      test/gen/test_placeh-crypto_gen.o
    CXX      test/test_placeh-key_properties.o
    ```
...
That's it! You are now running property-based tests in Placeholders Core.
