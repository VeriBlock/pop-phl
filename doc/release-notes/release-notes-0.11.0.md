Placeholders Core version 0.11.0 is now available from:

  <https://placehproject.com/bin/placeh-core-0.11.0/>
...
defaults to 0.00001. This will cause transactions with fewer PLACEH/kB fee to be
...
Block pruning allows Placeholders Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Placeholders Core will 
...
- #5729 `9c4a5a5` Allow unit changes for read-only PlaceholdersAmountField
...
- #6116 `30dc3c1` [OSX] rename Placeholders-Qt.app to Placeholders-Core.app
