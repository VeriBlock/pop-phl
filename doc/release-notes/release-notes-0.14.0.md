Placeholders Core version 0.14.0 is now available from:

  <https://placehproject.com/bin/placeh-core-0.14.0/>
...
Placeholders Core has supported automatically pruning the blockchain since 0.11. Pruning
...
When Placeholders Core is out-of-sync on startup, a semi-transparent information
...
The Alert System was [disabled and deprecated](https://placehproject.com/en/alert/2016-11-01-alert-retirement) in Placeholders Core 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Placeholders Core. This was added in conjunction with
