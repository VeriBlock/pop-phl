Placeholders Core version *0.15.2* is now available from:

  <https://placehcore.org/bin/placeh-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in placeh-tx (TheBlueMatt)
