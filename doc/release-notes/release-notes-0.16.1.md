Placeholders Core version 0.16.1 is now available from:

  <https://placehcore.org/bin/placeh-core-0.16.1/>
...
- #12843 `df38b13` Test starting placehd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure placehd processes are cleaned up when tests end (sdaftuar)
