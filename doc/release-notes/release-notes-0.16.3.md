Placeholders Core version 0.16.3 is now available from:

  <https://placehcore.org/bin/placeh-core-0.16.3/>
...
been discovered in Placeholders Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` placehconsensus: invalid flags error should be set to `placehconsensus_err` (afk11)
