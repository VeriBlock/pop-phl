...
Placeholders Core version 0.19.1 is now available from:

  <https://placehcore.org/bin/placeh-core-0.19.1/>
...
From Placeholders Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Placeholders Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Placeholders Core does not yet change appearance when
...
- #17488 fix "placehd already running" warnings on macOS (fanquake)
...
[Transifex](https://www.transifex.com/placeh/placeh/).
