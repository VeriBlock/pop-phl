Download URL: https://sourceforge.net/projects/placeh/files/Placeholders/placeh-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 PLACEH fee schedule (users still pay 0.01 PLACEH per kb, until next version)
