Placeholders version 0.5.4 is now available for download at:
http://sourceforge.net/projects/placeh/files/Placeholders/placeh-0.5.4/
...
Fix Placeholders-Qt notifications under Growl 1.3.
Increase required age of Placeholders-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPlaceholders properly when installing Placeholders-Qt over it. (Windows)
