Placeholders Core version 0.9.2.1 is now available from:

  https://placehproject.com/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PLACEH to 0.01 PLACEH
