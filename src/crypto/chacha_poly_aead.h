...
#ifndef PLACEH_CRYPTO_CHACHA_POLY_AEAD_H
#define PLACEH_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@placeh.
 *
 ...
 *
 * The chacha20-poly1305@placeh combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@placeh cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@placeh are relatively fast in
...
#endif // PLACEH_CRYPTO_CHACHA_POLY_AEAD_H
