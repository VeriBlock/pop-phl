...
static void SetupPlaceholderTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " placeh-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  placeh-tx [options] <hex-tx> [commands]  Update hex-encoded placeh transaction\n" +
            "or:     placeh-tx [options] -create [commands]   Create hex-encoded placeh transaction\n" +
            "\n";
