...
void PlaceholdersApplication::SetPrune(bool prune, bool force) {
...
{
    QMessageBox::critical(nullptr, "Runaway exception", PlaceholdersGUI::tr("A fatal error occurred. Placeholders can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
