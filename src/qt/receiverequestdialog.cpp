...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatPlaceholdersURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + PlaceholdersUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatPlaceholdersURI(info));
}
