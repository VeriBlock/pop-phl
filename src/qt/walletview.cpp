...
void WalletView::setPlaceholdersGUI(PlaceholdersGUI *gui)
{
    if (gui)
    {
        // Clicking on a transaction on the overview page simply sends you to transaction history page
        connect(overviewPage, &OverviewPage::transactionClicked, gui, &PlaceholdersGUI::gotoHistoryPage);

        // Navigate to transaction history page after send
        connect(sendCoinsPage, &SendCoinsDialog::coinsSent, gui, &PlaceholdersGUI::gotoHistoryPage);
        ...
        connect(this, &WalletView::encryptionStatusChanged, gui, &PlaceholdersGUI::updateWalletStatus);

        // Pass through transaction notifications
        connect(this, &WalletView::incomingTransaction, gui, &PlaceholdersGUI::incomingTransaction);

        // Connect HD enabled state signal
        connect(this, &WalletView::hdEnabledStatusChanged, gui, &PlaceholdersGUI::updateWalletStatus);
    }
}
