...
To run the unit tests manually, launch `src/test/test_placeh`. To recompile
...
To run the GUI unit tests manually, launch `src/qt/test/test_placeh-qt`
...
example, to run just the `getarg_tests` verbosely:
    ...
    test_placeh --log_level=all --run_test=getarg_tests -- DEBUG_LOG_OUT
