...
//{
//    script = CScript() << "btc" << "vbk1" << OP_POPVBKHEADER << "vbk2" << OP_POPVBKHEADER << OP_POPPHLHEADER << OP_CHECKPOP;
...
//{
//    script = CScript() << "ATV" << OP_CHECKATV << "VTB" << OP_CHECKVTB << "btc" << "vbk1" << OP_POPVBKHEADER << "vbk2" << OP_POPVBKHEADER << OP_POPPHLHEADER << OP_CHECKPOP;
...
//{
//    script = CScript() << "btc" << "veriblock header that is not equalto expected size" << OP_POPVBKHEADER << "vbk2" << OP_POPVBKHEADER << OP_POPPHLHEADER << OP_CHECKPOP;
//    BOOST_CHECK(!util.EvalScript(script, stack, &serror, nullptr, nullptr, nullptr, false));
//    BOOST_CHECK(serror == SCRIPT_ERR_PUSH_SIZE);
//}
//
...
//{
//    script = CScript() << "placeh header that is not equal to expected size" << OP_POPPHLHEADER << "vbk2" << OP_POPVBKHEADER << OP_CHECKPOP;
//    BOOST_CHECK(!util.EvalScript(script, stack, &serror, nullptr, nullptr, nullptr, false));
//    BOOST_CHECK(serror == SCRIPT_ERR_PUSH_SIZE);
//}
