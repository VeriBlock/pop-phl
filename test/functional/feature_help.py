...
class HelpTest(PlaceholdersTestFramework):
    ...
    def run_test(self):
        self.log.info("Start placeh with -h for help text")
        ...
        self.log.info("Start placeh with -version for version information")
        ...
        self.log.info("Start placehd with -fakearg to make sure it does not start")
