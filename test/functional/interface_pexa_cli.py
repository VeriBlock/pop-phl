...
# The block reward of coinbaseoutput.nValue (50) PLACEH/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 PLACEH/block.
BLOCKS = 101
BALANCE = (BLOCKS - 100) * 50

class TestPlaceholdersCli(PlaceholdersTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `placeh-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and placeh-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 PLACEH) to the default wallet.
