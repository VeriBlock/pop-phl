...
class P2PPermissionsTests(PlaceholdersTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].placehconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].placehconf, 'w', encoding="utf8") as f:
            f.write(newText)
