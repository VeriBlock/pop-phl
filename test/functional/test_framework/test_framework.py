...
TMPDIR_PREFIX = "placeh_func_test_"
...
class PlaceholdersTestFramework(metaclass=PlaceholdersTestMetaClass):
    ...
    def parse_args(self):
        ...
        parser.add_argument("--usecli", dest="usecli", default=False, action="store_true",
                            help="use placeh-cli instead of RPC for all commands")
    ...
    def _initialize_chain(self):
        ...
        for i in range(self.num_nodes):
            ...
            initialize_datadir(self.options.tmpdir, i, self.chain)  # Overwrite port/rpcport in placeh.conf
    ...
    def skip_if_no_wallet_tool(self):
        """Skip the running test if placeh-wallet has not been compiled."""
        if not self.is_wallet_tool_compiled():
            raise SkipTest("placeh-wallet has not been compiled")
    ...
    def is_wallet_tool_compiled(self):
        """Checks whether placeh-wallet was compiled."""
