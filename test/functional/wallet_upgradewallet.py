...
class UpgradeWalletTest(PlaceholdersTestFramework):
    ...
    def setup_nodes(self):
        ...
        adjust_placeh_conf_for_pre_17(self.nodes[1].placehconf)
        adjust_placeh_conf_for_pre_17(self.nodes[2].placehconf)
        self.start_nodes()
    ...
    def dumb_sync_blocks(self):
        ...
        Further info: https://github.com/placeh/placeh/pull/18774#discussion_r416967844
        """
    ...
    def run_test(self):
        ...
        # Copy the 0.16.3 wallet to the last Placeholders Core version and open it:
        ...
        self.stop_node(0)
        # Copy the 0.15.2 wallet to the last Placeholders Core version and open it:
        shutil.rmtree(node_master_wallet_dir)
        os.mkdir(node_master_wallet_dir)
        shutil.copy(
            v15_2_wallet,
